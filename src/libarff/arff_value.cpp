...
ArffValue::ArffValue(const std::string& str): m_int(0),
                                              m_float(0.0f),
                                              m_str(str),
                                              m_missing(false) {
        m_type = STRING;
...
ArffValue::ArffValue(const std::string& str, ArffValueEnum aType): m_int(0),
                                                                   m_float(0.0f),
                                                                   m_str(str),
                                                                   m_type(aType),
                                                                   m_missing(false) {
...
bool ArffValue::operator ==(const std::string& right) const {
    if((m_type != DATE) && (m_type != STRING) && (m_type != NOMINAL)) {
        return false;
    }
    return m_str == right;
}
